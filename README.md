...
1. If Databricks Repos is not enabled, begin by downloading the code from this repository.
   <img src="https://github.com/Peter-Mifsud/learn-testing-in-databricks/blob/feat/python-testing/Assets/Images/github-download.png?raw=true" alt="download_code" width="300"/>
